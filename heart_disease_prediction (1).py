    ...
    if result is not None:
        ...
        if result == 1:
            with col2:
                ...
                st.image("cardioRiskAnalyzerApp/un_healthy.jpg", use_column_width=True)  # Display image for safe
        elif result == 0:
            with col2:
                ...
                st.image("cardioRiskAnalyzerApp/healthy_heart.png", use_column_width=True)  # Display image for safe
